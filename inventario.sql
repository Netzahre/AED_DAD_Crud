...
-- Crear el trigger para actualizar 'TipoTexto'
DELIMITER $$
...
BEGIN
    IF NEW.Tipo = 0 THEN
        SET NEW.TipoTexto = 'Entrada';
    ELSEIF NEW.Tipo = 1 THEN
        SET NEW.TipoTexto = 'Salida';
    END IF;
END$$
...
INSERT INTO Producto (Descripcion, EAN, keyRFID) VALUES
    ('Osciloscopio marca Acme NS123', 1234567890123, 'RFID123'),
    ('Multímetro digital FL-20', 1234567890456, 'RFID456'),
    ('Proyector Epson X40', 1234567890789, 'RFID789'),
    ('Pizarra digital SmartBoard', 1234567890111, 'RFID111'),
    ('Microscopio Carl Zeiss', 1234567890222, 'RFID222');
